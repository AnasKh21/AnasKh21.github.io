...
export type Machine = {
  ...
  // Flag verification (optionnel si certaines machines n'ont pas de vérif)
  flagHash?: string;         // SHA-256 hex (lowercase)
  flagFormatHint?: string;   // ex: "PTM{...}"
};
...
export const machines: Machine[] = [
  {
    ...
    // ✅ à remplir avec le vrai hash plus tard
    flagFormatHint: "PTM{...}",
    flagHash: "PUT_SHA256_HEX_HERE",
  },
  {
    slug: "vm-two",
    title: "VM 2",
